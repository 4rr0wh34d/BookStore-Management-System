...
This Project includes 3 python files <ins>bookStoreGui.py</ins> which is the main file and the starting point for the program, <ins>access23.py</ins> which provides authentication functionality and <ins>excel23.py</ins> that provides functionality to read and write to Excel workbooks.
